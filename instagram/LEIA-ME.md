# Instagram @octomaker_

## Perfil
- Foto: perfil/perfil-instagram.png (logo redondo, feito para a moldura do Instagram)
- Nome: OctoMaker · Criação de Sites
- Link: https://octomaker.com.br
- Categoria: Serviço de design de sites
- Botões de contato: ative "Enviar mensagem" e "WhatsApp" na conta profissional
...
## Posts
Cada pasta tem as imagens e o arquivo legenda.txt. Publique na ordem dos números.
...
## Dicas
- Poste de 2 a 3 vezes por semana.
- Responda comentários e directs no mesmo dia.
- Os arquivos HTML em _fontes geram as imagens e podem ser editados para novos posts.
